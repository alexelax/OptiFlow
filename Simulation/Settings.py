...
class Settings:
    def __init__(self) -> None:
        ...
        self.winningPath='__winning.pkl'
        ...
        self.maxSimulationTime=3600*2      #il doppio del tempo teorico della simulaizone...       

        #ATTENZIONE! aggiungere una porta qua vuol dire anche aggiungere  un nuovo thread durante l'esecuzione
        self.ports=[8813,8814,8815,8816   ,8817,8818,8819,8820,  8821,8822,8823,8824,  8825,8826,8827,8828]
        #self.ports=[8813]s
