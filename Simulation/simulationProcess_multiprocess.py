...
class simulationProcess(Process):
    ...
    def __init__(self, id:int,network:neat.nn.FeedForwardNetwork,Settings,port=None, name=None, args=(), kwargs={}, daemon=None,GUI:bool=False,secondsFromStart=None):
    ...
    def run(self) :
        ...
        self.retValV2["total_simulation_time"]=self.retVal[0]
        self.retValV2["max_time_loss"]=self.retVal[1]
        self.retValV2["avg"]=self.retVal[2]
